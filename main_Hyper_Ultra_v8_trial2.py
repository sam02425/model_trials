...
for lr in learning_rates:
    for batch in batch_sizes:
        ...
        result_grid  = model.tune(data=dataset_yaml_path, imgsz=640, batch=batch, epochs=epochs, use_ray=True)
        ...
        for result in result_grid:
            plt.plot(result.metrics_dataframe["training_iteration"], result.metrics_dataframe["mean_accuracy"],
                     label=f"Trial {i}")
